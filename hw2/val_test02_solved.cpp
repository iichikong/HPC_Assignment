// g++ -g val_test02_solved.cpp -o val_test02_solved && valgrind
// --leak-check=full --track-origins=yes ./val_test02_solved
...
//
{
    ...
    //
    // !!!Fixed Point!!!
    // Originally the 5th to 10th elements in the array are not initialized,
    // then it could cause undefined behavior. To address this, I assign the
    // values to these elements here.
    for (i = 0; i < 10; i++) {
        x[i] = i;
    }
    //
