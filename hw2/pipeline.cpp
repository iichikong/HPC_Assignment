...
// g++ pipeline.cpp -O0 -o pipeline && ./pipeline
...
int main(int argc, char **argv) {
    ...
    s = sum1 + sum2;
    printf("Unrolliing by factor of 2              : %f ms  %f\n",
           t.toc() * 1000, s);
    ...
    s = sum1 + sum2;
    printf("Unrolling by factor of 2 with more opt : %f ms  %f\n",
           t.toc() * 1000, s);
    ...
    printf("Unrolling by factor of 4              : %f ms  %f\n",
           t.toc() * 1000, s);
    ...
    s = sum1 + sum2 + sum3 + sum4;
    printf("Unrolling by factor of 4 with more opt : %f ms  %f\n",
           t.toc() * 1000, s);
